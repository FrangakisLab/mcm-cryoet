...
from argparse import ArgumentParser, RawDescriptionHelpFormatter, ArgumentDefaultsHelpFormatter, BooleanOptionalAction
import sys
import numpy as np
import mrcfile
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--threshold", dest="threshold",
                        help="FFraction of the maximum value in map at which to threshold. No thresholding if omitted.", type=float,
